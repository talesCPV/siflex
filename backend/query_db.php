<?php
    ...
    $query_db = array(
         ...
         "18" => 'SELECT A.*, E.fantasia, E.id AS id_emp, E.cnpj, E.endereco, E.num, E.cidade, E.estado 
            ...
            ON x00 x01 x02 AND A.id_emp = E.id AND A.data_analise >= "x03" AND A.data_analise <= "x04" AND A.exec IN(x05) ORDER BY A.exec DESC, A.valor DESC, A.data_analise DESC;',
